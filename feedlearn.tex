...
We recruited 13 users who had not previously studied Japanese, who were interested in learning some basic vocabulary. They were voluntary participants recruited from online Facebook groups. All of our participants were regular users of Facebook. %, spending at least 10 minutes on the site each day.
...
The study is conducted entirely online. First, we asked the users to take a pre-test, to verify that they do not already know the vocabulary that we intend to teach them. In the pre-test, users tried matching the 50 Japanese words to their 50 English definitions. Then they installed our chrome extension and used it to learn the 50 words for a week. After a week elapsed, we asked them users to do the post-test, which had the same format as the pre-test.

\section{Results}

Average vocabulary pre-test and post-test scores are shown in Figure X.
