...
http://dx.doi.org/10.1145/2702613.2732775}
...
Some users mentioned that they would have preferred words to have been explicitly introduced first before they started appearing in quizzes.  In addition, as shown by our ``ratio of study sessions to insertions'', only 1/4 of quizzes are interacted with when seen in the feed. Hence, we need to ensure that the inserted items reinforce memory, even if the user does not interact with them. % In our next iteration of FeedLearn, we are addressing this issue by having an additional type of item that introduces a new word-definition pair, or serves to reinforce memory of it.
...
Although we have focused on vocabulary learning, other educational content could also be learned in the context of social feeds. Messaging in feeds could also be used to promote desireable habits such as microexercise.
